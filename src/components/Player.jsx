...
export function Player() {
  ...
  useEffect(() => {
    ...
    if (song) {
      ...
      audioRef.current.addEventListener("canplaythrough", () => {
        ...
        setIsPlaying(true); // Cambia a estado de reproducción si está listo
      });
    }
  }, [currentMusic]);
  ...
  // funcion para cambiar a la cancion anterior
      ...
      <div className="grid place-content-center gap-4 flex-1">
        <div className="flex justify-center flex-col items-center">
          <div className="flex flex-row items-center justify-between gap-4">
            <button className=" rounded-full p-2" onClick={handlePreviousClick}>
              <PreviousIcon />
            </button>
            <button className="bg-white rounded-full p-2" onClick={handleClick}>
              {isPlaying ? <Pause /> : <Play />}
            </button>
            <button className=" rounded-full p-2" onClick={handleNextClick}>
              <NextIcon />
            </button>
          </div>
